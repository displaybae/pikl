...
def describe_combine(images):
    ...
    content = [{"type": "text", "text": (
        ...
        "item description: color, type, length>'. Then end with one clause: 'Keep the person's "
        "<every remaining visible garment and accessory NOT being replaced, each with its color> "
        "exactly as they are, completely unchanged.' "
...
def verify_combine(images, result):
    ...
    content = [{"type": "text", "text": (
        ...
        "are NOT a problem. Only report clear violations. If everything is correct reply exactly "
